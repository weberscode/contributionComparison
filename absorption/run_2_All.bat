...
rfluxmtx -c 100 -V+ -ab 0 -t 5 -dj 0 sender2.rad receiversAll.rad -i scene.oct > dirr.mtx
...
rfluxmtx -c 100 -V+ -ab 6 -ad 25000 -lw 4.0000e-05 -t 5 -dj 0 sender2.rad receiversAll.rad -i scene.oct > tot.mtx
